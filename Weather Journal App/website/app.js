// OpenWeatherMap API Personal Key Credentials
...
// This Function is to get weather data from OpenWeatherMap API
const getWeatherInfo = async ( zipCode ) => {
	...
	try{
		...
		// Promise rejection if zip code is not found on OpenWeatherMap API
...
// Function to post AppData to the server
...
// Function for getting AppData from the server
...
// Update AppUI with the application retrieved data
